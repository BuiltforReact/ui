  ...
  return (<Layout>
    <main role="main" class="about-us">
      ...
      <div class="container">
        <div class="row mt-5">
          <div class="col">
            <p>BuiltForReact provides a mirror for react projects available on NPM. It combines information from npm and jsdelivr to provide useful stats to help choose the right package for your project.
            </p>
          </div>
        </div>
        ...
        <div class="row mt-3">
          <div class="col">
            <h3>Get Involved</h3>
            <a href="#">BuiltForReact</a>
            &nbsp; is open-source and we still have some work to do. Any contributions, ideas or bug reports are welcome.
            <br/>Visit our GitHub and help us!
            <h5 class="mt-3">Help Us</h5>
        ...
        <div class="row mt-3">
          <div class="col">
            ...
            <div class="card-deck tools-used">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    <ul>
                      ...
                      <li>
                        <a href="https://zeit.co/blog/next5">NextJS</a>
                      </li>
                      <li>
              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Data Sponsors</h5>
                  <p class="card-text">
                    <ul>
                      <li>
                      ...
                      <li>
                        <a href="https://npms.io">npms.io</a>
                      </li>
                      <li>
        ...
        <div class="row mt-5 mb-15">
          <div class="col">
            ...
            <a href="#">BuiltForReact</a>, uses the statistics provided by npms analytics that continuously analyzes the npm ecosystem, gathering as much information as possible from a variety of sources. Using the collected information, a final score for each package is calculated based on four different aspects:
            ...
            <div class="card-deck scores-calculated mt-3">
              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Personalities</h5>
                  <p class="card-text">
